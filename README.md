...
dsh plugin --profile web add '@dsh-community/dsh-paste-input@github:dsh-external/dsh-paste-input#v0.1.14'
...
> 1. 执行 `dsh plugin --profile web add '@dsh-community/dsh-paste-input@github:dsh-external/dsh-paste-input#v0.1.14'`（首次可能被 pnpm 11 拦截 node-pty 构建脚本而失败）
