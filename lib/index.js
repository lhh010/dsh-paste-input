...
// Real installed package version, resolved from the package.json beside this
// module (survives version bumps without editing built output; undefined is
// omitted from the JSON health payload).
  ...
  const route = async (req, res) => {
    ...
    try {
      if (req.method === 'GET' && suffix === '/health') {
        json(res, 200, { ok: true, plugin: name, protocol: 1, version: PLUGIN_VERSION });
        return;
      }
