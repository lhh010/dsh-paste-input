...
> - DSH **0.1.1-rc.2** (npm latest): install the **old** version `'@dsh-external/dsh-paste-input@github:dsh-external/dsh-paste-input#v0.1.5'`
...
> 1. Run `dsh plugin --profile web add '@dsh-community/dsh-paste-input@github:dsh-external/dsh-paste-input#v0.1.12'` (the first run may fail because pnpm 11 blocks node-pty build scripts)
