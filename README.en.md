...
> 1. Run `dsh plugin --profile web add '@dsh-community/dsh-paste-input@github:dsh-external/dsh-paste-input#v0.1.14'` (the first run may fail because pnpm 11 blocks node-pty build scripts)
