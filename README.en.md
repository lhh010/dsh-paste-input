...
> 1. Run `dsh plugin --profile web add '@dsh-community/dsh-paste-input@github:omdsh-dev/dsh-paste-input#v0.1.6'` (the first run may fail because pnpm 11 blocks node-pty build scripts)
